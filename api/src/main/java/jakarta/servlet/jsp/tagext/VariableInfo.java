 ...
 * by TagExtraInfo classes and it is used by the translation phase of Jakarta Pages (JSP).
 *
 * <p>
 ...
 * on which the Jakarta Pages (JSP) processor is built (like Jakarta EE). Using fully qualified class names in this manner makes the usage
 ...
 * user (the author), and it is thus less robust: for instance a missing import directive in the referring Jakarta Pages (JSP) page will
 ...
 *
 * <p>
 * The Jakarta Pages (JSP) specification defines the interpretation of 3 values:
 *
 * <ul>
 ...
 * &lt;variable&gt; subelement of the &lt;tag&gt; element. See the Jakarta Pages (JSP) specification.
 */

 ...
 *
 * <p>
 * If EVAL_BODY_BUFFERED is returned, then a BodyContent object will be created (by code generated by the Jakarta Pages (JSP) compiler)
 * to capture the body evaluation. The code generated by the Jakarta Pages (JSP) compiler obtains the BodyContent object by calling the
 ...
 * <B>Properties</B>
 * <p>
 * There is a new property: bodyContent, to contain the BodyContent object, where the Jakarta Pages (JSP) Page implementation object
 ...
 * action element is empty or not in the Jakarta Pages (JSP) page, not how it's declared in the TLD.
 *
 * <p>
...
public interface BodyTag extends IterationTag {
    ...
    /**
     * Set the bodyContent property. This method is invoked by the Jakarta Pages (JSP) page implementation object at most once per
    ...
    /**
     * Prepare for evaluation of the body. This method is invoked by the Jakarta Pages (JSP) page implementation object after

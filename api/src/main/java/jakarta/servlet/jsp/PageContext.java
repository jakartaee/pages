...
/**
 * <p>
 * PageContext extends JspContext to provide useful context information for when Jakarta Pages (JSP) technology is used in a Servlet
 * environment.
 * <p>
 * A PageContext instance provides access to all the namespaces associated with a Jakarta Pages (JSP) page, provides access to several
 ...
 * dependent implementations thereof, by conformant Jakarta Pages (JSP) engine runtime environments. A PageContext instance is obtained
 * by a Jakarta Pages (JSP) implementation class by calling the JspFactory.getPageContext() method, and is released by calling
 * JspFactory.releasePageContext().
 *
 * <p>
 * An example of how PageContext, JspFactory, and other classes can be used within a Jakarta Pages (JSP) Page Implementation object is
 * given elsewhere.
 *
 * <p>
 ...
 * <p>
 * Some methods are intended to be used by the code generated by the container, not by code written by Jakarta Pages (JSP) page authors,
 * or Jakarta Pages (JSP) tag library authors.
 * <p>
...
abstract public class PageContext extends JspContext {
    ...
    /**
     * <p>
     * The initialize method is called to initialize an uninitialized PageContext so that it may be used by a Jakarta Pages (JSP)
     ...
     * the <code> ServletContext </code> for this page. If the path does not begin with a "/" then the URL specified is
     * calculated relative to the URL of the request that was mapped to the calling page.
     * </p>
     * <p>
     * It is only valid to call this method from a <code> Thread </code> executing within a
     * <code> _jspService(...) </code> method of a page.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * The current JspWriter "out" for this page is flushed as a side-effect of this call, prior to processing the
     * include.
     * </p>
     * <p>
     * If the <I> relativeUrlPath </I> begins with a "/" then the URL specified is calculated relative to the DOCROOT of
     ...
     * </p>
     * <p>
     * If flush is true, The current JspWriter "out" for this page is flushed as a side-effect of this call, prior to
     ...
     * specified error page for this page. If forwarding is not possible (for example because the response has already
     ...
     *
     * <p>
     * A Jakarta Pages (JSP) implementation class shall typically clean up any local state prior to invoking this and will return
     ...
     * specified error page for this page, or if none was specified, to perform some implementation dependent action.
     *
     * <p>
     * A Jakarta Pages (JSP) implementation class shall typically clean up any local state prior to invoking this and will return
     * immediately thereafter. It is illegal to generate any output to the client, or to modify any ServletResponse
     ...
     *         page directive is not set to "true"), the information is meaningless.
     *
     * @since JSP 2.0
     */

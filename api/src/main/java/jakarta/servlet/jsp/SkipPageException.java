 ...
 * manually in a Jakarta Pages (JSP) page or tag file - the behavior is undefined. The exception is intended to be thrown inside
 * SimpleTag handlers and in Jakarta Pages (JSP) fragments.
 * 

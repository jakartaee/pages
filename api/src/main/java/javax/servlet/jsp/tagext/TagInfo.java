...
public class TagInfo {
     ...
     *
     * Note that a TagLibraryInfo element is dependent not just on the TLD information but also on the specific taglib
     * instance used. This means that a fair amount of work needs to be done to construct and initialize TagLib objects.
     *
     * If used carefully, this setter can be used to avoid having to create new TagInfo elements for each taglib
     * directive.
     *

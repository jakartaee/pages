...
public class TagAttributeInfo {
     ...
     * @param deferredMethod   Whether this attribute is a deferred method. rtexpr or deferred value.
     * @param expectedTypeName The name of the expected type of this deferred value (or <code>null</code> if this is not
     *                         a deferred value).
     * @param methodSignature  The expected method signature of this deferred method (or <code>null</code> if this is
     *                         not a deferred method).
     *
     * @since JSP 2.1
     */
    public TagAttributeInfo(String name, boolean required, String type, boolean reqTime, boolean fragment,
    ...
    /**
     * Whether this attribute has been specified in the TLD as rtexprvalue. If <code>true</code>, this means the
     * attribute can hold a request-time value.
     *
    ...
    /**
     * Returns <code>true</code> if this attribute is to be passed a <code>ValueExpression</code> so that expression
     ...
     * </p>
     *
     * @return <code>true</code> if this attribute accepts a deferred value; <code>false</code> otherwise.
     *
     * @since JSP 2.1
     */
    ...
    /**
     * Returns <code>true</code> if this attribute is to be passed a <code>MethodExpression</code> so that expression
     * evaluation can be deferred.
     *
     * <p>
     * If this method returns <code>true</code>, then <code>getTypeName()</code> must return
     ...
     * </p>
     *
     * @return <code>true</code> if this attribute accepts a deferred method; <code>false</code> otherwise.
     *
     * @since JSP 2.1
     */

...
`language` directive (see <<The `page` Directive>>). In JSP 4.1, the only
...
current page. See <<Summary of Include Mechanisms in JSP 4.1>> for a summary of include facilities.

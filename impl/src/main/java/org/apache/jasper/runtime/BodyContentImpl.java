...
public class BodyContentImpl extends BodyContent {
    ...
    /**
     * Clear the contents of the buffer. If the buffer has been already been flushed then the clear operation shall throw an
     * IOException to signal the fact that some data has already been irrevocably written to the client response stream.
     *
     * @throws IOException If an I/O error occurs
     */
    ...
    /**
     * Clears the current contents of the buffer. Unlike clear(), this mehtod will not throw an IOException if the buffer
     * has already been flushed. It merely clears the current content of the buffer and returns.
     *
     * @throws IOException If an I/O error occurs
     */
    ...
    /**
     * Close the stream, flushing it first. Once a stream has been closed, further write() or flush() invocations will cause
     * an IOException to be thrown. Closing a previously-closed stream, however, has no effect.
     *
     * @throws IOException If an I/O error occurs
     */
    ...
    /**
     * Return the value of this BodyJspWriter as a Reader. Note: this is after evaluation!! There are no scriptlets, etc in
     * this stream.
     *
    ...
    /**
     * Return the value of the BodyJspWriter as a String. Note: this is after evaluation!! There are no scriptlets, etc in
     * this stream.
     *
    ...
    /**
     * Write the contents of this BodyJspWriter into a Writer. Subclasses are likely to do interesting things with the
    ...
    public static void main(String[] args) throws Exception {
        ...
        bodyContent.writeOut(new PrintWriter(new OutputStreamWriter(System.out, "UTF-8")));
    }

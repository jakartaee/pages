...
public class JspRuntimeLibrary {
     ...
     * PageContext pageContext, VariableResolver variableResolver, FunctionMapper functionMapper ) throws JasperException {
     ...
     * functionMapper, null ) }); } catch (Exception ex) { throw new JasperException(ex); } }
     */
    public static void handleSetPropertyExpression(Object bean, String prop, String expression, PageContext pageContext, ProtectedFunctionMapper functionMapper)
        ...
        try {
            ...
            method.invoke(bean, new Object[] { PageContextImpl.evaluateExpression(expression, method.getParameterTypes()[0], pageContext, functionMapper) });
        } catch (Exception ex) {
            throw new JasperException(ex);
        }
    }

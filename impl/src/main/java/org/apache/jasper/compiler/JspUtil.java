...
public class JspUtil {
     ...
     */
    public static String interpreterCall(boolean isTagFile, String expression, Class expectedType, String fnmapvar, String expectedDeferredType,
            String expectedReturnType, String[] expectedParamTypes) {
        /*
        ...
        if (expectedType == jakarta.el.ValueExpression.class) {
            ...
            return "org.apache.jasper.runtime.PageContextImpl.getValueExpression" + "(" + Generator.quote(expression) + ", " + "(PageContext)" + jspCtxt + ", "
        ...
        if (expectedType == jakarta.el.MethodExpression.class) {
            ...
            return "org.apache.jasper.runtime.PageContextImpl.getMethodExpression" + "(" + Generator.quote(expression) + ", " + "(PageContext)" + jspCtxt + ", "
        ...
        StringBuilder call = new StringBuilder("(" + returnType + ") " + "org.apache.jasper.runtime.PageContextImpl.evaluateExpression" + "("
    ...
    static Map<String, Manifest> manifestMap = new ConcurrentHashMap<String, Manifest>();

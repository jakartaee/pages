...
public class SmapGenerator {
    ...
    /*
     * The SMAP syntax is reasonably straightforward. The purpose of this class is currently twofold: - to provide a simple
     * but low-level Java interface to build a logical SMAP - to serialize this logical SMAP for eventual inclusion directly
     * into a .class file.
     */
    ...
    /**
     * Adds the given SmapStratum object, representing a Stratum with logically associated FileSection and LineSection
     * blocks, to the current SmapGenerator. If <tt>default</tt> is true, this stratum is made the default stratum,
     * overriding any previously set default.
     *
     * @param stratum the SmapStratum object to add
     * @param defaultStratum if <tt>true</tt>, this SmapStratum is considered to represent the default SMAP stratum unless
     * overwritten
     */
     ...
     * @param stratumName the name of the stratum output by the compilation that produced the <tt>smap</tt> to be embedded
     */
    ...
    /**
     * Instructs the SmapGenerator whether to actually print any embedded SMAPs or not. Intended for situations without an
     * SMAP resolver.
     *

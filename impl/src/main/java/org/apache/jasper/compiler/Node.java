...
/**
 * An internal data representation of a JSP page or a JSP docuement (XML). Also included here is a visitor class for
 * tranversing nodes.
 *
...
abstract class Node implements TagConstants {
    ...
    /*
     * The name of the inner class to which the codes for this node and its body are generated. For instance, for <jsp:body>
     * in foo.jsp, this is "foo_jspHelper". This is primarily used for communicating such info from Generator to Smap
     * generator.
     */
    ...
    /**
     * Searches all subnodes of this node for jsp:attribute standard actions with the given name, and returns the
     * NamedAttribute node of the matching named attribute, nor null if no such node is found.
     * <p>
    ...
    /**
     * Searches all subnodes of this node for jsp:attribute standard actions, and returns that set of nodes as a Node.Nodes
     * object.
     *
    ...
    /**
     * Selects and invokes a method in the visitor class based on the node type. This is abstract and should be overrode by
    ...
    public static class Root extends Node {
         ...
         *
         * True if the page does not provide a page directive with a 'contentType' attribute (or the 'contentType' attribute
         * doesn't have a CHARSET value), the page does not provide a page directive with a 'pageEncoding' attribute, and there
         * is no JSP configuration element page-encoding whose URL pattern matches the page.
         */
        private boolean isDefaultPageEncoding;

        /*
         * Indicates whether an encoding has been explicitly specified in the page's XML prolog (only used for pages in XML
         * syntax). This information is used to decide whether a translation error must be reported for encoding conflicts.
         */
        ...
        /**
         * @return The enclosing root to this Root. Usually represents the page that includes this one.
         */
    ...
    public static class PageDirective extends Node {
        ...
        /**
         * Parses the comma-separated list of class or package names in the given attribute value and adds each component to
         * this PageDirective's vector of imported classes and packages.
         *
    ...
    public static abstract class ScriptingElement extends Node {
        ...
        /**
         * When this node was created from a JSP page in JSP syntax, its text was stored as a String in the "text" field,
         * whereas when this node was created from a JSP document, its text was stored as one or more TemplateText nodes in its
         * body. This method handles either case.
         *
    ...
    public static class UninterpretedTag extends Node {
        ...
        public UninterpretedTag(String qName, String localName, Attributes attrs, Attributes nonTaglibXmlnsAttrs, Attributes taglibAttrs, Mark start,
                Node parent) {
    ...
    public static class CustomTag extends Node {
        ...
        /**
         * The following two fields are used for holding the Java scriptlets that the tag plugins may generate. Meaningful only
         * if useTagPlugin is true; Could move them into TagPluginContextImpl, but we'll need to cast tagPluginContext to
         * TagPluginContextImpl all the time...
         */
        ...
        public CustomTag(String jspVersion, String qName, String prefix, String localName, String uri, Attributes attrs, Mark start, Node parent,
            ...
            this(jspVersion, qName, prefix, localName, uri, attrs, null, null, start, parent, tagFileInfo);
        }
         ...
         */
        public CustomTag(String jspVersion, String qName, String prefix, String localName, String uri, Attributes attrs, Attributes nonTaglibXmlnsAttrs,
                Attributes taglibAttrs, Mark start, Node parent, TagFileInfo tagFileInfo) {
        ...
        /*
         * Gets this custom tag's custom nesting level, which is given as the number of times this custom tag is nested inside
         * itself.
         */
        ...
        /*
         * Computes this custom tag's custom nesting level, which corresponds to the number of times this custom tag is nested
         * inside itself.
         *
         * Example:
         *
         * <g:h> <a:b> -- nesting level 0 <c:d> <e:f> <a:b> -- nesting level 1 <a:b> -- nesting level 2 </a:b> </a:b> <a:b> --
         * nesting level 1 </a:b> </e:f> </c:d> </a:b> </g:h>
         *
         ...
         *
         * A custom action is considered to have an empty body if the following holds true: - getBody() returns null, or - all
         * immediate children are jsp:attribute actions, or - the action's jsp:body is empty.
         */
    ...
    public static class NamedAttribute extends Node {
        ...
        /*
         * Get the attribute value from this named attribute (<jsp:attribute>). Since this method is only for attributes that
         * are not rtexpr, we can assume the body of the jsp:attribute is a template text.
         */
        public String getText() {
    ...
    public static class TemplateText extends Node {
         ...
         *
         * @param srcLine The postion of the source line, relative to the line at the start of this node. The corresponding java
         * line is assumed to be consecutive, i.e. one more than the last.
         */
     ...
     *
     * Can either be a plain attribute, an attribute that represents a request time expression value, or a named attribute
     * (specified using the jsp:attribute standard action).
     */
    ...
    public static class JspAttribute {
        ...
        JspAttribute(String qName, String uri, String localName, String value, ELNode.Nodes el, String expectedType, String expectedReturnType,
        ...
        /**
         * Use this constructor if the JspAttribute represents a named attribute. In this case, we have to store the nodes of
         ...
         *
         * @return the value for the attribute, or the expression string (stripped of "<%=", "%>", "%=", or "%" but containing
        ...
        /**
         * @return true if the value represents an expression that should be fed to the expression interpreter
         * @return false for string literals or rtexprvalues that should not be interpreted or reevaluated
         */
    ...
    /**
     * A visitor class for visiting the node. This class also provides the default action (i.e. nop) for each of the child
     * class of the Node. An actual visitor should extend this class and supply the visit method for the nodes that it
     * cares.
     */
    public static class Visitor {

        /**
         * This method provides a place to put actions that are common to all nodes. Override this in the child visitor class if
         * need to.
         */

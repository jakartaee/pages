...
:authors: Jakarta Debugging Support for Other Languages Team, https://projects.eclipse.org/projects/ee4j.jdsol
:email: https://dev.eclipse.org/mailman/listinfo/jdsol-dev
:version-label!:
:doctype: book
